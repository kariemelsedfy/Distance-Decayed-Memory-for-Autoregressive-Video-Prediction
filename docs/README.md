...
- [PROJECT_PLAN.md](PROJECT_PLAN.md): scientific scope, phases, and operating rules.
...
- [DATASETS.md](DATASETS.md): dataset provenance, licensing, hashes, and locations.
- `journal/`: dated, plain-language progress notes for the owner.

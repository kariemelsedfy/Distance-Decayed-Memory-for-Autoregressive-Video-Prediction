...
| `a1-smoke` | 2026-09-23 | `5cedefd` | A1 trainer smoke: M model, 64-frame clips, batch 4/GPU, 300 steps, FlexAttention, bf16; pilot split as train and val | pending | `mixed`, 2× pro6000, 16 CPU, 128 GB, 45 min | `runs/a1-smoke-*/` | submitted | Engineering check only: throughput, memory, checkpoint, validation, sample GIF. Not a research result. |

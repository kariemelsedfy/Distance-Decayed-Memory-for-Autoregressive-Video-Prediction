...
| `memmaze9-pilot` | 2026-09-23 | `d65adc9` | pilot split: 200 episodes × 2,048 frames, 8 shards × 25, seeds 3,000,000–3,000,199 | pending | `main`, 8 array tasks × 1 CPU, 6 GB, 2 h cap; setup 30 min; finalize 1 h | `data/memmaze9/pilot/`, `runs/memmaze9-pilot-*/` | submitted | A0 pilot: generation speed at scale, gap coverage, spot-check grid. |
